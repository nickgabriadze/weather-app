            ...
            <div className={navstyle['wrapper']}>
                ...
                <div className={navstyle['search-city']}>
                    <div className={navstyle['search']}>
                        ...
                        <input placeholder="Search for your city" value={city} onChange={(e) => setCity(e.target.value)}></input>
                    </div>
                    <button className={navstyle['enter']}
                    
                    onClick={() => {

                            dispatch(setWeatherLocation({
                                providedCity: "".concat(city[0].toUpperCase()).concat(city.slice(1).toLowerCase()),
                            }))
